...
where `=zero?` is as defined in exercise [2.80](#%_thm_2.80). (See also
...
More precisely, if *P* and *Q* are polynomials, let *O*~1~ be the order
...
<span id="footnote_Temp_314">[^60^](#call_footnote_Temp_314)</span> The
